...
const runPartition = (label, bundle) => {
  ...
  assert.equal(evaluated.chainObject, 'air-lde-only-even-x');
  ...
  assert.equal(evaluated.host.poseidon2Air.labeledFriOfAir, true);
  assert.equal(evaluated.airWall, null);
