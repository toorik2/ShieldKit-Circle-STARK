...
/**
 * Conservative v15 root-bound worksheet for the worst profile. Every entry is
...
export function localShaWordCopySoundness(
  ...
  // Profile 2 has the largest public statement boundary: 34 words.
  const publicBoundaryTerms = 34;
