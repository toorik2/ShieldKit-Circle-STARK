...
export const HOST_ORACLE_SPLIT = Object.freeze({
  ...
  inProof: Object.freeze([
    ...
    'Poseidon2-M31 snapshot-quotient Q=C/π^9(x) computed on the host; even-x FRI of published Q; residual-at-openings',
  ]),
  ...
  reason: [
    ...
    'hash. Snapshot-quotient even-x q2 unlocking 10735–11823 (blowup 2) exceeds 10k.',
