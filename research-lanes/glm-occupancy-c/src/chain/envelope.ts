 ...
 * Full-completeness B is now a standard-size tx (~91–93 KB), so the 100_000
 * standard fee covers it (fee == size is rejected; fee == size+1 accepts).
 * Raise this if a consensus compile grows past 99_999 B.
 */
export const CONSENSUS_SUCCESSOR_FEE_SATS = 100_000n;
